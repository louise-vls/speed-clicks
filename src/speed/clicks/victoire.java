...
SpeedClick scJeu;
     ...
     */
    public victoire(SpeedClick scJeu) {
        initComponents();
        this.scJeu = scJeu;
    }
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
        public void run() {
            ...
            victoire victoireFrame = new victoire(speedClick); // Créez une instance de defaite avec une référence à SpeedClick
            victoireFrame.setVisible(true);
        }
    });
}
